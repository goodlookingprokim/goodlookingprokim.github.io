...
![에이전트가 단일 챗봇을 넘어 그래프 오케스트레이션, MCP·RAG·A2A 같은 연결 규격, 재사용 가능한 스킬 자산, 영구 기억 구조 위에서 실제로 굴러가는 흐름을 한국어로 정리한 고급형 인포그래픽](./2026-08-01-agents-run-on-graphs-and-reusable-skills-release-40-infographic-ko-premium.svg)
